...
target_compile_definitions(git INTERFACE
        S2_GIT_COMMIT_HASH="${GIT_SHA1}"
        S2_GIT_COMMIT_DATE="${GIT_DATE}"
        S2_GIT_TAG="${GIT_TAG}"
        S2_GIT_COMMIT_SUBJECT="${GIT_COMMIT_SUBJECT}"
        S2_GIT_BRANCH="${GIT_BRANCH}"
        S2_GIT_URL="${GIT_URL}"
)